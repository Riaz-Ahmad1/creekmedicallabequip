...
<body id="page-top">
          ...
          <div class="row">
            <div class="col-md-12">
              ...
              <div class="d-sm-flex align-items-center justify-content-between mb-4">
                <h1 class="h3 mb-0 text-gray-800">User's Call Back Requests</h1>
              </div>
              <!-- Content Row -->
                  ...
                  ?>
                    <tr id="row_541" role="row" class="even">
                      ...
                      <td class="text-center">
                        <?php
                        if ($status == 1) {
                          echo " <a class='btn btn-sm btn-primary text-white' href='callreq.php?read=$id'>
                               un-called
                              </a>";
                              echo "<a onclick=\"return confirm('Are you sure To Delete Record?')\" class='delete btn btn-sm btn-danger text-white' href='callreq.php?delete=$id'>
                        ...
                        <?php
                          ...
                          echo " <a onclick=\"return confirm('Are you sure To Delete Record?')\" class='btn btn-sm btn-danger text-white' href='callreq.php?delete=$id'>
                              <i class='fas fa-trash-alt'></i>
                              </a>";
                        }
                        ?>
  ...
  if (isset($_GET['delete'])) {
    ...
    $delete_query = "DELETE from callreq where id='$deleteid'";
    $result =  mysqli_query($db, $delete_query);
    if ($result) {
      header('location:callreq.php');
    } else {
      echo '
  ...
  if (isset($_GET['read'])) {
    $requestid = $_GET['read'];
    $sql = "UPDATE callreq set status='0' where id='$requestid'";
